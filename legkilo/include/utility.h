...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<std::string>("lio_sam/highStateTopic", highStateTopic, "high_state");
        ...
        nh.param<string>("lio_sam/savePath", savePath, "/home/jason/KILO_GT1/0517_4floor8_00.csv");
        

        nh.param<double>("lio_sam/maxLinearVel", maxLinearVel, 3.0);
        nh.param<double>("lio_sam/maxAngularVel", maxAngularVel, 2 * M_PI);
        nh.param<int>("lio_sam/correctStamp", correctStamp, 1);
        nh.param<float>("lio_sam/lidarFreq", lidarFreq, 10);
